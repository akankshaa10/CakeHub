...
<html>
<head>
  <title>Dry Cake with Dates and Valnuts</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<br>
<br><br>
<fieldset><legend><h1 style="color:yellow;">Dry Cake with Dates and Valnuts</h1></legend><br>

    <img src="product-images/drypnut.jpg" usemap="#pnut" height="300" width="300" align="left">
<map name="pnut">
...
$sql = "SELECT * FROM drytbl where id=2";
