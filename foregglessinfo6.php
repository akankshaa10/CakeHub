...
<html>
<head>
  <title>Eggless Rose and Pistachio Cake</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<br>
<br><br>
<fieldset><legend><h1 style="color:yellow;">Eggless Rose and Pistachio Cake</h1></legend><br>

    <img src="product-images/egglessrose.jpg" usemap="#eglsros" height="300" width="300" align="left">
<map name="eglsros">
...
$sql = "SELECT * FROM egglesstbl where id=6";
...
<script type="text/javascript">
  function redirect()
  {
    window.location.href="eggless.php";
  }
</script>
