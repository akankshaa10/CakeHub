...
switch($_GET["action"]) {
  case "add":
    if(!empty($_POST["quantity"])) {
      $productByCode = $db_handle->runQuery("SELECT * FROM egglesstbl WHERE code='" . $_GET["code"] . "'");
...
<HEAD>
<TITLE>Eggless Cake</TITLE>
<link href="egglessstyle.css" type="text/css" rel="stylesheet" />
</HEAD>
<BODY>
<div id="shopping-cart">
<div class="txt-heading" style="color: white">Shopping Cart</div>

<a id="btnEmpty" href="eggless.php?action=empty">Empty Cart</a>
<?php
...
?>
<td align="right" colspan="2"><strong><?php echo "Rs. ".$tot; ?></strong></td>
<td></td>
</tr>
</tbody>
</table>    
...
<div id="product-grid">
  ...
  <?php
  $product_array = $db_handle->runQuery("SELECT * FROM egglesstbl ORDER BY id ASC");
  ...
  <!--<script type="text/javascript">
    ...
    <div class="product-item">
      <form method="post" action="eggless.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
