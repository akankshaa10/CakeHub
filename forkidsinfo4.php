...
<br>
<br><br>
<fieldset><legend><h1 style="color:yellow;">Minions Cake</h1></legend><br>

    <img src="product-images/minion.jpg" usemap="#min" height="300" width="300" align="left">
<map name="min">
...
$sql = "SELECT * FROM kidstbl where id=4";
