...
switch($_GET["action"]) {
  case "add":
    if(!empty($_POST["quantity"])) {
      $productByCode = $db_handle->runQuery("SELECT * FROM kidstbl WHERE code='" . $_GET["code"] . "'");
...
<HEAD>
<TITLE>Kids Cake</TITLE>
<link href="kidsstyle.css" type="text/css" rel="stylesheet" />
</HEAD>
<BODY>
<div id="shopping-cart">
<div class="txt-heading" style="color: white">Shopping Cart</div>

<a id="btnEmpty" href="kids.php?action=empty">Empty Cart</a>
<?php
...
<?php   
    ...
    ?>
        ...
        <td style="text-align:center;"><a href="kids.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
        </tr>
        <?php
...
<div id="product-grid">
  ...
  <?php
  $product_array = $db_handle->runQuery("SELECT * FROM kidstbl ORDER BY id ASC");
