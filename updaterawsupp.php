...
<html>
<head>
	<title>Update Raw Materials Supplier</title>
	<style type="text/css">
...
<center><h2>***  UPDATE  RAW  MATERIAL  SUPPLIER  ***</h2></center>
<br><br><br><br>
...
if(isset($_POST['updt']))
{
	$suppnme=$_POST['suppnme'];
	$suppag=$_POST['suppag'];
	$suppgen=$_POST['suppgen'];
	$phnno=$_POST['phnno'];
	$suppitm=$_POST['suppitm'];
	$bil=$_POST['bil'];
	...
	$query="UPDATE rawsuppliers SET suppnme='$_POST[suppnme]',suppag='$_POST[suppag]',suppgen='$_POST[suppgen]',phnno='$_POST[phnno]',suppitm='$_POST[suppitm]',bil='$_POST[bil]',suppdate='$_POST[suppdate]',adres='$_POST[adres]',suppem='$_POST[suppem]' WHERE suppid='$_POST[suppid]'";
