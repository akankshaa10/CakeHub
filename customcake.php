...
?>
    <h3>Please Fill Form Below & Send Your Requirements</h3><br><br>
<table align="center">
    <form action="customcakedb.php" method="post">
      
      <label>Your Name:</label><br>
      <input type="text" name="name" align="center"  placeholder="Enter name" required=""><br><br> <br>
      ...
      <input type="number" name="mobno" align="center"  placeholder="Enter Mobile Number" required=""> <br><br><br>

      <label>Expected Delivery Date:</label> <br>
      <input type="date" name="expdte" align="center"  placeholder="Enter Expected delivery date" required=""><br><br><br>

      <label>Required Cake Weight:</label> <br>
      <input type="text" name="rqwt" align="center"  placeholder="Enter cake weight" required=""><br><br><b></b>

      <label>Mentioned Your Requirements :</label><br>
      <textarea name="requi" rows="6" cols="25"  placeholder="Enter requirements" required=""></textarea><br><br><br>

      <label>Attach sample Designs :</label><br><br>
      <input type="file" name="uplimg" required=""><br><br><br>  
