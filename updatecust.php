...
<center><h2>***  UPDATE  CUSTOMERS  ***</h2></center>
<br><br><br><br>
...
if(isset($_POST['upd']))
{
	...
	$query="UPDATE customers SET custnme='$_POST[custnme]',custag='$_POST[custag]',custgen='$_POST[custgen]',phno='$_POST[phno]',dte='$_POST[dte]',cakenm='$_POST[cakenm]',cost='$_POST[cost]',addr='$_POST[addr]',custem='$_POST[custem]' WHERE custid='$_POST[custid]'";
