...
<br>
<br><br>
<fieldset><legend><h1 style="color:yellow;">Chocolate Cake</h1></legend><br>

    <img src="product-images/family.jpg" usemap="#fam" height="300" width="300" align="left">
<map name="fam">
...
$sql = "SELECT * FROM phototbl where id=1";
