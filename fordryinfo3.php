...
<html>
<head>
  <title>Vanilla Almond Dry Cake</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<br>
<br><br>
<fieldset><legend><h1 style="color:yellow;">Vanilla Almond Dry Cake</h1></legend><br>

    <img src="product-images/dryalmond.jpg" usemap="#almnd" height="300" width="300" align="left">
<map name="almnd">
...
$sql = "SELECT * FROM drytbl where id=3";
