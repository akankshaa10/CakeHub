...
<br>
<br><br>
<fieldset><legend><h1 style="color:yellow;">Cheese Dry Cake</h1></legend><br>

    <img src="product-images/drycheese.jpg" usemap="#ches" height="300" width="300" align="left">
<map name="ches">
...
$sql = "SELECT * FROM drytbl where id=4";
